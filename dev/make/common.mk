...
secure.opts.icc.lnx = -Wformat -Wformat-security -O3 -D_FORTIFY_SOURCE=2 -fstack-protector-strong

secure.opts.icc.mac = -Wformat -Wformat-security -O3 -D_FORTIFY_SOURCE=2 -fstack-protector
secure.opts.icc.fbsd = -Wformat -Wformat-security -O3 -D_FORTIFY_SOURCE=2 -fstack-protector-strong
